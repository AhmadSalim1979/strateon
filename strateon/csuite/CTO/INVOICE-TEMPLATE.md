...
<div class="invoice-wrapper">
  ...
  <div class="invoice-header">
    <div class="company-brand">
      <!-- Replace with: <img src="https://getstrateon.com/logo.png" alt="Strateon" class="logo-img" style="max-width:140px;margin-bottom:12px;"> -->
      <div class="logo-placeholder"><!-- Strateon Logo --></div>
      <div class="brand-name">Strateon</div>
      <div class="brand-tagline">Strategy, Executed.</div>
      <div style="margin-top:16px; font-size:12px; color:#c8d0e8; line-height:1.7;">
        <div>ahmad.salim@getstrateon.com</div>
        <div>getstrateon.com</div>
      </div>
    </div>
  ...
  <div class="addresses">
    <div class="address-block">
      ...
      <div class="company-name">Strateon</div>
      <div class="contact-name">Ahmad Salim</div>
      <div class="email">ahmad.salim@getstrateon.com</div>
  ...
  <div class="late-payment-notice">
    <p>
      ...
      Strateon reserves the right to suspend services for accounts with balances overdue by
  ...
  <div class="invoice-footer">
    Strateon &nbsp;|&nbsp; ahmad.salim@getstrateon.com &nbsp;|&nbsp; getstrateon.com<br>
    This invoice was generated by Strateon. Thank you for your business.
  </div>
...
| `{{ACCOUNT_NAME}}` | Bank account holder name | `Strateon GmbH` |
| `{{IBAN}}` | IBAN | `DE89 3704 0044 0532 0130 00` |
| `{{SWIFT}}` | SWIFT/BIC code | `COBADEFFXXX` |
| `{{PAYMENT_LINK}}` | Online payment URL | `https://pay.getstrateon.com/invoice/…` |
