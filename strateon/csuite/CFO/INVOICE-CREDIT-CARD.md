...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .invoice-header::before {
    ...
    right: 0;
    height: 80px;
    background: url('https://www.qiyadon.com/assets/qiyadon-banner.jpg') no-repeat center center;
...
<div class="invoice-wrapper">
  ...
  <div class="invoice-header">
    <div class="invoice-header-inner">
      <div class="company-brand">
        <!-- Qiyadon Red Logo Mark -->
        <img src="https://www.qiyadon.com/csuite/CMO/assets/qiyadon-logo-red.png" alt="Qiyadon" style="max-width:120px;margin-bottom:12px;">
  ...
  <div class="invoice-footer">
    <img src="https://www.qiyadon.com/csuite/CMO/assets/qiyadon-logo-silver.png" alt="Qiyadon" style="max-width:60px;margin-bottom:8px;"><br>
