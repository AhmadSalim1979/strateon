...
const demoBanner = `<div style="background:#fff8e8;border:1px solid #d4b88b;border-radius:8px;padding:12px 16px;margin-bottom:16px;font-size:12px;color:#8a5a00;text-align:center;">
  📄 Demo Report — This is a sample report generated by Qiyadon. Client "CloudSync Pro" is fictional.
</div>`;

// Strip the demo banner from the embedded HTML to avoid doubling
const reportBody = reportHTML.replace(/<div class="demo-banner">.*<\/div>\n/s, '');
